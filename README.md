...
Cowork의 Linux OS 기본 경로(`/root/.local/share/...`, `~/.local/share/...`)는 컨테이너 내부이므로 지속 저장소로 인정하지 않습니다. Cowork에서는 연결된 Windows/Mac `HareM365Agent` 폴더의 마운트 루트를 `--data-dir`로 명시해야 합니다.
