...
폴더 접근 권한이 없으면 파일 탐색기나 데스크톱 제어로 우회하지 말고, Claude/Cowork의 폴더 연결 기능으로 Hare M365 Agent 전용 폴더 연결/허용을 먼저 요청합니다. 요청 메시지에는 "문서/Documents 안의 Hare M365 Agent 폴더"라고 명확히 안내합니다. 사용자가 임의 경로를 판단하게 하지 말고, SharePoint 공용 폴더, Teams 공유 폴더, 다운로드 폴더 전체, 바탕화면 전체는 선택하게 하지 않습니다.
